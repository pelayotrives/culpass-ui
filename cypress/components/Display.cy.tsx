...
describe('Display Component', () => {
  it('renders with default props', () => {
    ...
    cy.get('p').should('have.class', 'text-display');
    cy.get('p').contains('Default Display');
  });

  it('renders with different font sizes', () => {
    mount(<Display fontSize="display1">Display 1</Display>);
    cy.get('p').should('have.class', 'text-display-xl');

    mount(<Display fontSize="display2">Display 2</Display>);
    cy.get('p').should('have.class', 'text-display-lg');
  });
